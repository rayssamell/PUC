...
public class Pokemon {
    ...
    public static int insertionSort(List<Pokemon> pokemon){
        int movimentacoes = 0; // para contar numero de movimentacoes
        ...
        for (int i = 1; i < pokemon.size(); i++) {
            ...
            if(temp.getCaptureDate().compareTo(pokemon.get(j).getCaptureDate()) == 1){
                while ((j >= 0) && (temp.getName().compareTo(pokemon.get(j).getName()) < 0)){
            ...
            //caso contrario ordena pela data 
                ...
                while ((j >= 0) && (temp.getCaptureDate().compareTo(pokemon.get(j).getCaptureDate()) < 0)){
                    pokemon.set(j+1, pokemon.get(j));
                    movimentacoes++;
                    j--;
                }
    ...
    public static void main(String[] args){
        ...
        //tempo de execucao
        inicio = pokemon.now();
        int movimentacoes = insertionSort(newList); // ordenar lista
        fim = pokemon.now();
        
        pokemon.print(newList); // mostrar lista ordenada
