...
---------------------------------------------- previsao de testes
a.)Entrar com uma palavra: carro
4: [o]
3: [r]
2: [r]
1: [a]
...
b.)Entrar com uma palavra: cortina
6: [a]
5: [n]
4: [i]
3: [t]
...
0: [c]
---------------------------------------------- erros
0	-1	In function 'method_06':
[Aviso]  unused variable 'x' [-Wunused-variable]
Solucao: 'int x = 0;' nao estava sendo utilizado logo nao eh necessario.
---------------------------------------------- historico
