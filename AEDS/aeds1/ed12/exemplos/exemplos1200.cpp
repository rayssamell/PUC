...
// repetir até desejar parar
	do
	{
		...
		cout << "Opcoes " << endl;
		cout << " 0 - parar "                                             << endl;
		cout << " 1 - mostrar dados em matriz "                           << endl;
		...
		cout << " 5 - criar um objeto com dados copiados de outra matriz" << endl;
		cout << " 6 - testar se a matriz só contém zeros."                << endl;
		cout << " 7 - testar se matrizes são diferentes"                  << endl;
		cout << " 8 - subtrair dados em matrizes, posição por posição"    << endl;
		cout << " 9 - a calcular o produto de matrizes"                   << endl;
