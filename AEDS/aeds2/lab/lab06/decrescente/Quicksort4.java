...
public class Quicksort4 {
    ...
    private void QuickSortMedianOfThree(int esq, int dir) {
        int i = esq, j = dir;
        int meio = (esq+dir)/2;
        //seleciona o pivo como a mediana dos tres valores
    ...
    public static void main(String[] args) {
        ...
        Quicksort4 quickFirst = new Quicksort4(100);
        quickFirst.decrescente();
