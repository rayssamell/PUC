...
protected:
	...
	void setErro ( int codigo ){
		...
		case 0:
			...
			break;
		case 1:
			msgErro = "[ERRO] Cadeia de Caracteres Vazia.";
			break;
		case 2:
			msgErro = "[ERRO} Posicao invalida.";
			break;
		case 3:
			msgErro = "[ERRO} Tamanho invalido.";
			break;
		case 4:
			msgErro = "[ERRO} A cadeia nao inicia com o prefixo.";
			break;
		case 5:
			msgErro = "[ERRO} A cadeia nao termina com o sufixo.";
			break;
		default:
